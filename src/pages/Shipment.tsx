      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm lg:col-span-2">
          <h3 className="text-base font-extrabold text-gray-900 pb-3 border-b border-gray-100 flex items-center gap-2">
            <Compass className="w-5 h-5 text-[#0B2C6B]" />
          ...
          <div className="overflow-x-auto mt-4">
            <table className="w-full text-left border-collapse text-sm sm:text-base font-bold">
              <thead>
                <tr className="border-b border-gray-300 text-gray-700 font-extrabold uppercase tracking-wider text-xs sm:text-sm">
                  ...
                  <th className="pb-3 text-center bg-gray-50 text-gray-800 rounded-t-lg">Total Shipment</th>
                </tr>
              </thead>
                ...
                {breakdownMatrix.map((row, idx) => (
                  <tr
                    ...
                    className={`hover:bg-blue-50/50 transition-colors cursor-pointer ${
                      typeFilter === row.key ? "bg-blue-50/80 font-black" : ""
                    }`}
                  >
                    <td className="py-4 font-extrabold text-gray-950 flex items-center gap-2 text-sm sm:text-base">
                      <span className={`w-3 h-3 rounded-full ${
                        row.type === "Ekspor" ? "bg-sky-500" : row.type === "Impor" ? "bg-blue-500" : "bg-emerald-500"
                      }`}></span>
                      {row.type}
                    </td>
                    <td className="py-4 text-center text-sky-800 font-extrabold font-mono text-sm sm:text-base">{row.preTrip}</td>
                    <td className="py-4 text-center text-blue-800 font-extrabold font-mono text-sm sm:text-base">{row.onTrip}</td>
                    <td className="py-4 text-center text-emerald-800 font-extrabold font-mono text-sm sm:text-base">{row.endTrip}</td>
                    <td className="py-4 text-center font-black text-gray-950 bg-gray-50/75 rounded-b-lg font-mono text-sm sm:text-base">{row.total}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div>
            ...
            <div className="mt-5 space-y-4">
              <div className="bg-emerald-50/50 border border-emerald-100 p-4 rounded-xl text-center">
                <span className="text-[10px] text-emerald-800 font-bold uppercase tracking-wider block">On-Time Delivery Rate</span>
                <span className="text-4xl font-black block text-emerald-700 mt-1">94.8%</span>
                <span className="text-xs font-bold text-emerald-600 block mt-1">SLA target exceeded (+3.8%)</span>
              </div>

              <div className="grid grid-cols-2 gap-3 text-center">
                <div className="bg-gray-50/80 p-3 rounded-lg border border-gray-100">
                  <span className="text-[9px] text-gray-400 font-bold block uppercase tracking-wider">Avg Loading SLA</span>
                  <span className="text-base font-bold text-gray-800 mt-0.5 block">1.8 hrs</span>
                </div>
                <div className="bg-gray-50/80 p-3 rounded-lg border border-gray-100">
                  <span className="text-[9px] text-gray-400 font-bold block uppercase tracking-wider">Avg Transit SLA</span>
                  <span className="text-base font-bold text-gray-800 mt-0.5 block">14.2 hrs</span>
                </div>
              </div>
            </div>
          </div>

          <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider mt-5">
      ...
      <div className="space-y-4">
        <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm space-y-4">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 pb-3 border-b border-gray-100">
            <div>
              <h3 className="text-base font-extrabold text-gray-900">Shipment Monitoring Log (Klik Row untuk Action/Advance Trip)</h3>
              <p className="text-xs text-gray-400 font-semibold mt-0.5">Real-time GPS transit checkpoints & trip status switcher</p>
            </div>

            <div className="text-xs font-bold text-gray-500">
              Showing <strong className="text-blue-900 font-extrabold">{filteredShipments.length}</strong> of {shipments.length} shipments
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-3">
            ...
            <div className="relative flex-1 min-w-[220px]">
              ...
              <input
                ...
                className="w-full bg-gray-50 border border-gray-200 text-xs font-medium rounded-xl pl-8 pr-7 py-2.5 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#0B2C6B] text-gray-800"
              />
              {searchQuery && (
                <button
